/*
=====================================================================
 PROGRAM ANALISIS JARINGAN WIFI (VERSI SEDERHANA)
=====================================================================
 Fitur:
 ...
 CATATAN:
 - Hanya jalan di Windows (pakai perintah "netsh wlan show networks")
 - Compile: g++ wifi_simple.cpp -o wifi_simple.exe
